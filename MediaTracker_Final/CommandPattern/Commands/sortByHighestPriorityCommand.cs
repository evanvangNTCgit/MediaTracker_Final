...
namespace MediaTrackerFinal.CommandPattern.Commands
{
    ...
    /// <summary>
    /// This command will sort a media list by the highest priority.
    /// </summary>
    public class SortByHighestPriorityCommand : ICommand
    {
        private ObservableCollection<Media> medias;

        /// <summary>
        /// Initializes a new instance of the <see cref="SortByHighestPriorityCommand"/> class.
        /// </summary>
        /// <param name="medias">Observable media collection to sort.</param>
        public SortByHighestPriorityCommand(ObservableCollection<Media> medias)
        {
            this.medias = medias;
        }
